var deltaCalculator = require('./ModifiedObjectDiffCalculator.js');
...
var deltaObj={};
deltaCalculator.ObjectDiffCalculator(obj1,obj2,deltaObj);
console.log(JSON.stringify(deltaObj));
/*
OUTPUT:
pratyush@pratyushv-pc:~$ node sample_app.js
{
  "id": {
